...
public class ViewProfileFaculty extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewProfileFaculty frame = new ViewProfileFaculty();
	...
	public ViewProfileFaculty() {
		...
		JLabel lblUserProfile = new JLabel("<---click here to  see the profile");
		lblUserProfile.setBounds(278, 7, 189, 14);
		...
		lblFatherName.setBounds(24, 79, 89, 14);
		...
		JLabel lblUserid = new JLabel("UserType");
		lblUserid.setBounds(24, 221, 78, 14);
		contentPane.add(lblUserid);
		
		textField_3 = new JTextField();
		textField_3.setBounds(126, 221, 161, 20);
		...
		btnSeeProfile.setBounds(155, 7, 102, 23);
