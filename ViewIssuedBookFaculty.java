...
public class ViewIssuedBookFaculty extends JFrame 
{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewIssuedBookFaculty frame = new ViewIssuedBookFaculty();
	 ...
	 * Create the frame.
	 */
	public ViewIssuedBookFaculty() {
		super("View issued books");
		...
		lblViewIssuedBooks.setBounds(346, 0, 129, 14);
