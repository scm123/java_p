...
public class RequestBookFaculty extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RequestBookFaculty frame = new RequestBookFaculty();
	...
	public RequestBookFaculty() {
		...
		btnSend.setBounds(120, 260, 89, 23);
		...
		btnReset.setBounds(220, 260, 89, 23);
		...
		lblQuantity.setBounds(10, 224, 75, 14);
		contentPane.add(lblQuantity);
		
		textField_4 = new JTextField();
		textField_4.setBounds(131, 221, 160, 20);
